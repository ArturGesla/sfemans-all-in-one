MODULE user_data_module
  TYPE personalized_data
     ...
     REAL(KIND = 8), DIMENSION(2)            :: solid_vel
...
CONTAINS
  ...
  SUBROUTINE read_user_data(data_file)
    ...
    !.......Continue here ................................
        ...
        !===Imposed Vel========================================================
        ! CN 20/05/2016 user%solid_vel(1:2) = f_bot, f_top
        ...
        !===disk's permeability==================================================
! CN 22/06/2021
        CALL find_string(unit_file, '===Disk Permeability', test)
        IF (test) THEN
            READ(unit_file, *) user%mu_disk
        ELSE
            user%mu_disk = 1.d0
        END IF
